...
public class DraftFolderPage { // описание страницы при переходе в черновики https://e.mail.ru/drafts/
    ...
    private By draftMessageSavedLastInFolderEmail = By.xpath("(//span[@title='test@mail.ru'])[1]");//ДИНАМИЧЕСКИЙ!! нужно вводить актуальную почту адресата
    private By draftMessageSavedLastInFolderTheme = By.xpath("(//span[text()='Тема'])[1]");//ДИНАМИЧЕСКИЙ!! нужно вводить актуальную почту адресата
    private By draftMessageSavedLastInFolderText = By.xpath("(//span[contains(text(), 'Сообщение')])[1]");//ДИНАМИЧЕСКИЙ!! нужно вводить актуальную почту адресата
